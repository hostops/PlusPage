            ...
            try {
                ...
                for (int r = 0; r <= 150; r++) {
                    ...
                    if (podatki[r1][0] != null) {
                        ...
                        statement.executeUpdate("INSERT INTO UPORABNIKI (ID, IME, PRIIMEK, EMAIL, UPORABNIK, GESLO, DATUMROJSTVA, SPOL, NASLOV, X, Y, XN, YN, VISINA, SIRINA, NOVOOKNO, SCROLLING, POVECAVA) "
