                        ...
                        if (ime.equals(piskotpodatek[0]) && priimek.equals(piskotpodatek[1]) && email.equals(piskotpodatek[2]) && uporabnik.equals(piskotpodatek[3]) && geslo.equals(piskotpodatek[4])) {
                            ...
                            if (naslov.contains("#") && naslov.length() == 7 && gg == 0) {
                                ...
                                if (novookno == true) {
                                    ...
                                    out.println("<br/><input style=\"z-index: +2; position:relative\" id='novocheck" + idstevec + "' type=\"checkbox\"  value=\"\">Povezave odpri v novem oknu.</input></br>\n");
                                }
                                if (scrolling == true) {
                                    out.println("<input style=\"z-index: +2; position:relative\" id='scrollcheck" + idstevec + "' type=\"checkbox\"  value=\"\" checked >Omogoči možnost drsenja.</input></br>");
                                } else {
                                    out.println("<input style=\"z-index: +2; position:relative\" id='scrollcheck" + idstevec + "' type=\"checkbox\"  value=\"\"  >Omogoči možnost drsenja.</input></br>"
                                            + ""
                                            + "");
                                }
