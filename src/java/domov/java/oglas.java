...
//delo z bazo
            ...
            try {
                ...
                while (cursor.next()) {
                    ...
                    if (oglas.equalsIgnoreCase("avto")) {
                        x1 = AVTO;
                    } else if (oglas.equalsIgnoreCase("avtoZosebo")) {
                        x1 = AVTOZOSEBO;
                    } else if (oglas.equalsIgnoreCase("cevlji")) {
                        x1 = CEVLJI;
                    } else if (oglas.equalsIgnoreCase("cevljiZosebo")) {
                        x1 = CEVLJIZOSEBO;
                    } else if (oglas.equalsIgnoreCase("delnice")) {
                        x1 = DELNICE;
                    } else if (oglas.equalsIgnoreCase("delniceZosebo")) {
                        x1 = DELNICEZOSEBO;
                    } else if (oglas.equalsIgnoreCase("FILM")) {
                        x1 = FILM;
                    } else if (oglas.equalsIgnoreCase("FILMZOSEBO")) {
                        x1 = FILMZOSEBO;
                    } else if (oglas.equalsIgnoreCase("GRADBENISTVO")) {
                        x1 = GRADBENISTVO;
                    } else if (oglas.equalsIgnoreCase("GRADBENISTVOZOSEBO")) {
                        x1 = GRADBENISTVOZOSEBO;
                    } else if (oglas.equalsIgnoreCase("NEGA")) {
                        x1 = NEGA;
                    } else if (oglas.equalsIgnoreCase("NEGAZOSEBO")) {
                        x1 = NEGAZOSEBO;
                    } else if (oglas.equalsIgnoreCase("POTOVANJA")) {
                        x1 = POTOVANJA;
                    } else if (oglas.equalsIgnoreCase("RACUNALNIKI")) {
                        x1 = RACUNALNIKI;
                    } else if (oglas.equalsIgnoreCase("SPLET")) {
                        x1 = SPLET;
                    } else if (oglas.equalsIgnoreCase("SPLETZOSEBO")) {
                        x1 = SPLETZOSEBO;
                    } else if (oglas.equalsIgnoreCase("ZDRAVJE")) {
                        x1 = ZDRAVJE;
                    } else if (oglas.equalsIgnoreCase("ZDRAVJEZOSEBO")) {
                        x1 = ZDRAVJEZOSEBO;
                    }
                ...
                for (int i = 0; i < seznamstrani.length; i++) {
                    if (seznamstrani[i] != null) {
                        if (!seznamstrani[i].equals("-") && !seznamstrani[i].equals("") && seznamstrani[i] != null) {
                            if (seznamstrani[i].contains("#") && seznamstrani[i].length() == 7) {
                            } else {
                                statement1.executeUpdate("INSERT INTO OGLASI (NASLOV, AVTO, AVTOZOSEBO, CEVLJI, CEVLJIZOSEBO, DELNICE, DELNICEZOSEBO, FILM, FILMZOSEBO, GRADBENISTVO, GRADBENISTVOZOSEBO, NEGA, NEGAZOSEBO, POTOVANJA, POTOVANJAZOSEBO, RACUNALNIKI, RACUNALNIKIZOSEBO, SPLET, SPLETZOSEBO, ZDRAVJE, ZDRAVJEZOSEBO) \n"
