...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function removePicker() {
			...
			document.getElementById('footer1').removeChild(jscolor.picker.boxB);
		}
		...
		function drawPicker(x, y) {
			...
			p.box.style.width = '230px';
			p.box.style.height = '120px';

			// picker border
			p.boxB.style.position = 'relative';
			
			p.boxB.style.left = '0px';
			p.boxB.style.top = '0px';
			p.boxB.style.zIndex = THIS.pickerZIndex;
			p.boxB.style.border = THIS.pickerBorder+'px solid';
			p.boxB.style.borderColor = THIS.pickerBorderColor;
			p.boxB.style.background = THIS.pickerFaceColor;
                        p.boxB.style.width = '230px';
			p.boxB.style.height = '120px';
			...
			document.getElementById('footer1').appendChild(p.boxB);
		}
